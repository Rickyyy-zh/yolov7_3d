...
import argparse
from vis_utils import get_cam_8_points, read_json, vis_label_in_img, read_txt_label_to_dict

def vis_label_in_image_txt(path, save_path):
    ...
    with open(set_path, 'r') as f:
        ...
        for file in file_names:
            ...
            labels = []
            oris = read_txt_label_to_dict(p_lb)
            for ori in oris:
...
def add_arguments(parser):
    ...
    parser.add_argument("--output-file", type=str, default="visualize/")
...
if __name__ == "__main__":
    ...
    vis_label_in_image_txt(args.path, args.output_file)
